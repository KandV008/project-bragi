 ...
 * DISCLAIMER
 * 
 * This translation is the one created by the Clerk community, I have only made 
 * a series of changes in some sections to adapt it to this web application.
 * 
 * All credits to the original contributors of this localization.
 * 
 * Link to the original translation: https://github.com/clerk/javascript/blob/main/packages/localizations/src/es-ES.ts
 */
...
export const customLocalization = {
  ...
  signIn: {
    ...
    start: {
      actionLink: 'Registrate ahora mismo.',
      ...
      subtitle: 'Inicie sesión para acceder a tu cuenta',
  ...
  signUp: {
    continue: {
      actionLink: "Inicie sesión ahora mismo.", 
