export default function Filter() {
  return (
    <section
      className=" p-4 rounded flex-col space-y-3
        bg-primary0 dark:bg-secondary2 text-primary2 dark:text-secondary0 h-full
        hidden md:flex w-64"
    >
      <h1 className="text-3xl font-bold">Filtrar por:</h1>
      ...
      <article className="text-lg">
        ...
        className="px-3">
          ...
          <br></br>
          <input type="checkbox" id="range2" name="range2" value="range2" />
          <label htmlFor="range2"> Intracanal - dentro del canal auditivo</label>
          <br></br>
          <input type="checkbox" id="range3" name="range3" value="range3" />
          <label htmlFor="range3"> CIC - completamente en el canal auditivo</label>
          <br></br>
          <input type="checkbox" id="range4" name="range4" value="range4" />
          <label htmlFor="range4"> RIC - auricular dentro del conducto auditivo</label>
          <br></br>
        </form>
      </article>
      <article className="text-lg">
