...
import { METHOD_ACTION_CREATE_PRODUCT, METHOD_ACTION_DELETE_PRODUCT, METHOD_ACTION_UPDATE_PRODUCT, METHOD_GET_ALL_PRODUCTS, METHOD_GET_LATEST_PRODUCTS, METHOD_GET_PRODUCT, METHOD_GET_PRODUCT_BY_CATEGORY, METHOD_GET_PRODUCTS_BY_IDS, METHOD_GET_RELATED_PRODUCTS, METHOD_SEARCH_PRODUCTS } from "../dbConfig"
...
describe(METHOD_GET_ALL_PRODUCTS, () => {
    ...
    it("should get 10 Products when the start index is 0 and end index is 9", async () => {
        const numOrders = 10
    ...
    it("should get 0 Products when there is any product", async () => {
        const numOrders = 0
        const fakeOrders = createFakeProducts(numOrders, fakeCategory)
    ...
    it("should throw an error when the products are not correct", async () => {
...
describe(METHOD_GET_PRODUCT_BY_CATEGORY, () => {
    ...
    it("should get 10 EARPHONE Products when the start index is 0 and end index is 9", async () => {
        const numOrders = 10
        const fakeOrders = createFakeProducts(numOrders, fakeCategory)
    ...
    it("should get 10 ACCESSORY Products when the start index is 0 and end index is 9", async () => {
        const numOrders = 10
    ...
    it("should get 0 Products when there is any product with that category", async () => {
        const numOrders = 0
        const fakeOrders = createFakeProducts(numOrders, fakeCategory)
...
describe(METHOD_GET_LATEST_PRODUCTS, () => {
    ...
    it("should get the 4 last products", async () => {
        const numOrders = 4
        const fakeOrders = createFakeProducts(numOrders, fakeCategory)
...
describe(METHOD_GET_RELATED_PRODUCTS, () => {
    ...
    it("should get 4 related products", async () => {
        const numOrders = 4
        const fakeOrders = createFakeProducts(numOrders, fakeCategory)
    ...
    it("should get 0 related products when there is no product related", async () => {
        const numOrders = 0
        const fakeOrders = createFakeProducts(numOrders, fakeCategory)
...
describe(METHOD_GET_PRODUCTS_BY_IDS, () => {
    ...
    it("should get 5 products using only the ids", async () => {
        const numOrders = 5
        const fakeOrders = createFakeProducts(numOrders, fakeCategory)
...
describe(METHOD_ACTION_CREATE_PRODUCT, () => {
    ...
    it("should not create a new Product Entity", async () => {
...
describe(METHOD_ACTION_UPDATE_PRODUCT, () => {
    ...
    it("should not updated a Product Entity", async () => {
...
describe(METHOD_ACTION_DELETE_PRODUCT, () => {
    ...
    it("should delete a Product Entity and all it apperances in shopping lists and favorites", async () => {
    ...
    it("should not delete a Product Entity", async () => {
    ...
    it("should throw an Error when some deletion fail", async () => {
