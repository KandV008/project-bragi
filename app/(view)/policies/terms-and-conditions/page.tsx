    ...
    <>
      ...
      <>
        ...
        <p>
          ...
          nuestros productos.{" "}
          <a href="https://audifonosxmenos.com">https://audifonosxmenos.com</a>{" "}
      ...
      {/* LICENCIA */}
      <>
        <ArticleHeader text={"LICENCIA"} id="licencia" />
        <p>
          AFORDA VISION S.L. a través de su sitio web concede una licencia para
      ...
      {/* USO NO AUTORIZADO */}
      <>
        <ArticleHeader text={"USO NO AUTORIZADO"} id="uso-no-autorizado" />
        <p>
      ...
      {/* PROPIEDAD */}
      <>
        <ArticleHeader text={"PROPIEDAD"} id="propiedad" />
        <p>
          ...
          ningún tipo de garantía, expresa o implícita. En ningún caso esta
          compañía será responsables de ningún daño incluyendo, pero no limitado
          a, daños directos, indirectos, especiales, fortuitos o consecuentes u
          otras pérdidas resultantes del uso o de la imposibilidad de utilizar
          nuestros productos.
        </p>
      </>
      ...
      <>
        <ArticleHeader
          ...
          id="pol-tica-de-reembolso-y-garant-a"
        />
        <p>
      ...
      {/* PRIVACIDAD */}
      <>
        <ArticleHeader text={"PRIVACIDAD"} id="privacidad" />
        <p>
          Este{" "}
          <a href="https://audifonosxmenos.com">https://audifonosxmenos.com</a>{" "}
        ...
        <p>
          AFORDA VISION S.L. reserva los derechos de cambiar o de modificar
