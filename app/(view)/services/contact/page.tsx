    ...
    <>
      ...
      <section className="flex flex-col lg:flex-row w-full gap-3">
        ...
        <article className={`flex flex-col lg:w-1/2 gap-4 lg:gap-8 m-2 md:mt-0 lg:mx-5 px-2 lg:px-5 justify-around
            ...
            <div>En esta página puedes <span className="font-bold">contactar con nosotros</span> para resolver cualquier necesidad que tengas relacioanda con nosotros.</div>
            <ul className="px-5 lg:px-10 font-semibold">
                <li>* ¿Quieres contactar con nostros por la razón que sea? </li>
