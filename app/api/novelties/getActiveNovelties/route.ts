...
import { getActiveNovelties, getNovelties } from "@/db/novelty/novelty";
import { NextResponse } from "next/server";

/**
 * Handles the GET request to fetch a list of active novelties. The request includes pagination parameters
 ...
 * @returns {NextResponse} The HTTP response containing the list of active novelties or an error message.
 */
export async function GET(request: Request) {
    ...
    try {
        const novelties = await getActiveNovelties(startIndex, endIndex);
