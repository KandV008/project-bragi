...
import Product from "@/app/ui/components/products/product/product";
...
describe("<Product />", () => {
  ...
  it(`[${COMPONENT_TEST_TAG}] should render Product as no preview, with image, name, brand, price and buttons`, () => {
